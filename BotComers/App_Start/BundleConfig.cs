    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/resource").Include(
                "~/Resource/UserControl.Helper.js",
                "~/Resource/General.js"));
            // jQuery
            bundles.Add(new ScriptBundle("~/bundles/jquery").Include(
                        "~/Scripts/default/jquery-1.10.2.min.js", "~/Scripts/jquery-2.1.1.min.js"));
            ...
            // Inspinia script
            bundles.Add(new ScriptBundle("~/bundles/inspinia2").Include(
                      "~/Scripts/plugins/metisMenu/metisMenu.min.js",
                      "~/Scripts/plugins/pace/pace.min.js",
                      "~/Scripts/app/inspinia0.js"));
            // Inspinia skin config script
            bundles.Add(new ScriptBundle("~/bundles/skinConfig").Include(
                      "~/Scripts/app/skin.config.min1.js"));
