...
{
    /// <summary>
    /// Descripción breve de ExportarPostVentaSegmentacionInactivos
    /// </summary>
    public class ExportarPostVentaSegmentacionInactivos : IHttpHandler
    {

        public void ProcessRequest(HttpContext context)
        {
            string Titulo = "LISTADO DE TOTAL CLIENTES VENCIDOS C/S ACTIVIDADES";
            ...
            context.Response.AddHeader("Content-Disposition", "attachment;filename=InformeSociosInactivos.xls");
