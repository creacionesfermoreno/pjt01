...
if (localStorage.getItem("listaProductos") != null) {
    ...
    function funcionForEach(item, index) {
        ...
        $(".cuerpoCarrito").append(
            ...
            '<p class="precioCarritoCompra text-center">S/<span>' + item.precio + '</span></p>' +
            ...
            '<strong>S/<span>' + item.precio + '</span></strong>' +
...
$(".cantidadItem").change(function () {
    ...
    $(".subTotal" + idProducto).html('<strong>S/<span>' + (cantidad * precio) + '</span></strong>');
...
function sumaSubtotales() {
    ...
    $(".sumaSubTotal").html('<strong>S/<span>' + sumaTotal + '</span></strong>');
...
function divisas(metodoPago) {
    ...
    if (metodoPago == "paypal") {
        ...
        $("#cambiarDivisa").append('<option value="S/">S/</option>' +
