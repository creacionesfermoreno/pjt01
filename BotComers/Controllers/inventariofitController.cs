...
namespace BotComers.Controllers
{
    ...
    public class inventariofitController : Controller
    {
        // GET: inventario
        ...
        public ActionResult buscarproducto(int id)
        {
            using (ItemsVentaRepository oItemsVentaRepository = new ItemsVentaRepository())
            {
                ...
                return Json(oItemsVentaRepository.ecommerce_uspBuscarItemsVentas(CodigoUnidadNegocio, CodigoSede, CodigoItemVenta), JsonRequestBehavior.AllowGet);
            }
        }

        public ActionResult ecommerce_uspListarMovimientoItemVentaPorItemVenta(int id, int PageNumber)
        {
            using (InventariofitRepository oItemsVentaRepository = new InventariofitRepository())
            {
                int CodigoUnidadNegocio = Commun.CodigoUnidadNegocio;
                int CodigoSede = Commun.CodigoSede;
                int CodigoItemVenta = id;
                return Json(oItemsVentaRepository.ecommerce_uspListarMovimientoItemVentaPorItemVenta_Paginaciones(CodigoUnidadNegocio, CodigoSede, CodigoItemVenta, PageNumber), JsonRequestBehavior.AllowGet);
            }
        }

        public ActionResult valorinventario()
        {
            List<ItemsVentaViewModel> lista = new List<ItemsVentaViewModel>();
        ...
        public ActionResult ListarValorInventario(int CodigoAlmacen)
        {
            using (ItemsVentaRepository oItemsVentaRepository = new ItemsVentaRepository())
            {
                ItemsVentaViewModel request = new ItemsVentaViewModel();
